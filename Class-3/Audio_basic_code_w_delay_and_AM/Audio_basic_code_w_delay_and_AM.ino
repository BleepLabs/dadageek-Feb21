...
AudioSynthWaveform       waveform5;      //xy=133.75,333.75
AudioSynthWaveform       waveform1;      //xy=153.99996948242188,91.99997901916504
AudioMixer4              mixer1;         //xy=286.49996185302734,170.99995613098145
AudioEffectMultiply      multiply1;      //xy=438.750036239624,203.7500171661377
AudioEffectDelay         delay1;         //xy=459.75562286376953,444.0056266784668
AudioMixer4              mixer2;         //xy=470.7553825378418,313.50562286376953
AudioMixer4              mixer3;         //xy=637.0056304931641,153.75568008422852
...
AudioConnection          patchCord4(waveform5, 0, multiply1, 1);
AudioConnection          patchCord5(waveform1, 0, mixer1, 0);
AudioConnection          patchCord6(mixer1, 0, multiply1, 0);
AudioConnection          patchCord7(multiply1, 0, mixer3, 0);
...
AudioControlSGTL5000     sgtl5000_1;     //xy=244.49993133544922,642.0000157356262
...
void setup() {
  ...
  waveform5.begin(1, 440.0, WAVEFORM_SINE);
...
void loop() {
  ...
  freq5 = potRead(7)*400.0;
  waveform5.frequency(freq5);
